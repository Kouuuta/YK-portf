  ...
  return (
    <section className="py-24 px-6 md:px-12 bg-[#111]" id="skills" ref={ref}>
      <div className="container mx-auto max-w-5xl">
        ...
        <motion.div
          className="mt-20 bg-[#0c0c0c] rounded-xl p-8 relative overflow-hidden"
          initial={{
            opacity: 0,
          }}
          animate={
        ...
        >
          <motion.div
            className="absolute top-0 right-0 w-64 h-64 bg-[#4ecca3]/10 rounded-full -translate-y-1/2 translate-x-1/2"
            animate={{
              scale: [1, 1.2, 1],
              opacity: [0.3, 0.2, 0.3],
            }}
          ...
          <div className="relative z-10">
            ...
            <motion.button
              className="px-6 py-3 bg-[#4ecca3] text-black font-medium rounded-full hover:bg-[#3db892] transition-colors"
              whileHover={{
                scale: 1.05,
              }}
              whileTap={{
